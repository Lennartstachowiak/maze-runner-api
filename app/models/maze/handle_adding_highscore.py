from app.controller.maze.add_maze_highscore import (
    add_maze_highscore_controller,
)
from app.controller.maze.remove_maze_highscore import (
    remove_maze_highscore_controller,
)
...
def handle_adding_maze_highscore(user_id, maze_id, algorithm_id, solution):
    ...
    for user_highscore_object in user_highscore_list:
        user_highscore_dict = {
            "id": user_highscore_object.id,
            "score": user_highscore_object.score,
        }
    ...
    best_highscore = min(user_highscores, key=lambda user_highscore: user_highscore["score"])
