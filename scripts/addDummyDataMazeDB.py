...
dummy_mazes = [{"name": "Beginner Maze", "difficulty": "Easy", "imgLink": simple_maze_image_base_64,
               "structure": simple_maze.structure, "height": simple_maze.height, "width": simple_maze.width},
               {"name": "Intermediate Maze", "difficulty": "Medium", "imgLink": medium_maze_image_base_64,
               "structure": medium_maze.structure, "height": medium_maze.height, "width": medium_maze.width},
               {"name": "Advanced Maze", "difficulty": "Hard", "imgLink": hard_maze_image_base_64,
